    ...
    bottom_resizable_{true}
{
  ...
  builder_->get_widget("tempoBox", tempo_box_);
...
void MainWindow::initUI()
{
  ...
  tempo_box_->pack_start(tempo_scale_, Gtk::PACK_EXPAND_WIDGET);
  tempo_scale_.set_adjustment(tempo_adjustment_);
  tempo_scale_.set_valign(Gtk::ALIGN_FILL);
  tempo_scale_.set_halign(Gtk::ALIGN_FILL);
  tempo_scale_.set_round_digits(0);
  tempo_scale_.set_draw_value(false);
  tempo_scale_.show();
