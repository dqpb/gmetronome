...
private:
  ...
  Gtk::Switch* percussive_clap_switch_;
  Gtk::Switch* bell_switch_;
  Gtk::Scale* balance_scale_;
  Glib::RefPtr<Gtk::Adjustment> tonal_pitch_adjustment_;
  Glib::RefPtr<Gtk::Adjustment> tonal_timbre_adjustment_;
  Glib::RefPtr<Gtk::Adjustment> tonal_detune_adjustment_;
  Glib::RefPtr<Gtk::Adjustment> tonal_punch_adjustment_;
  Glib::RefPtr<Gtk::Adjustment> tonal_decay_adjustment_;
  Glib::RefPtr<Gtk::Adjustment> percussive_tone_adjustment_;
  Glib::RefPtr<Gtk::Adjustment> percussive_punch_adjustment_;
  Glib::RefPtr<Gtk::Adjustment> percussive_decay_adjustment_;
